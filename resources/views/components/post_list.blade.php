...
.selected_post{
  ...
  <div class="row">
    <div class="col">
            <h3 class="mb-3 text-center mt-2">{{$heading}}</h3>
...
<table class="table">
  <thead class="thead-dark">
    <tr>
      ...
      <th scope="col" class="align-middle text-center">Admin Email</th>
  ...
  <tbody>
    @foreach ($posts as $post)
     <tr>
      ...
      <td class="align-middle text-center">{{$post->admin->email}}</td>
...
<input type="submit" value="Approve Selected" id="approve_selected" class="btn-success btn-sm rounded-pill">
@endif
...
if(user_type=='blogger' || user_type=='admin')
 {
     let form_action='{{route('posts.delete_selected_post')}}';
